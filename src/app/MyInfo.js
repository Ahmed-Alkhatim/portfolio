...
export default function MyInfo() {
    ...
    return(
        <div>
            ...
            <div className="lap:block hidden mb-[64px] text-center relative">
                <div className="inline-block bg-gradient-to-r from-black/90 via-gray-900/90 to-black/90 rounded-lg border border-primary/30 p-6 font-mono shadow-2xl backdrop-blur-sm">
            ...
            <div 
                ref={cardRef}
                className="m-auto mb-10 w-[430px] p-[24px] pb-[36px] border-[4px] border-[#FFF] rounded-tl-[160px] rounded-br-[160px] space-y-[32px] relative group hover:border-primary transition-all duration-500 bg-gradient-to-br from-gray-2/50 to-black/30 backdrop-blur-sm interactive-overlay"
            ...
            >
                ...
                {/* Enhanced animated background pattern with syntax highlighting */}
                <div className="absolute inset-0 opacity-10 pointer-events-none overflow-hidden rounded-tl-[160px] rounded-br-[160px] font-mono text-xs">
                ...
                <div className="text-center relative z-10">
                    <div className="inline-block m-auto relative">
                        <div className="relative group/profile">
                            ...
                            {/* Enhanced floating code particles with animations */}
                            <div className="absolute -top-6 -left-6 text-primary/40 text-sm font-mono floating opacity-0 group-hover/profile:opacity-100 transition-opacity delay-100">
                                <span className="inline-block animate-bounce" style={{animationDelay: '0s'}}>&lt;</span>
                                <span className="inline-block animate-bounce" style={{animationDelay: '0.1s'}}>/</span>
                                <span className="inline-block animate-bounce" style={{animationDelay: '0.2s'}}>&gt;</span>
                            </div>
                            <div className="absolute -top-4 -right-8 text-primary/40 text-sm font-mono floating opacity-0 group-hover/profile:opacity-100 transition-opacity delay-200">
                                <span className="inline-block animate-bounce" style={{animationDelay: '0.3s'}}>{`{`}</span>
                                <span className="inline-block animate-bounce" style={{animationDelay: '0.4s'}}>{`}`}</span>
                            </div>
                            <div className="absolute -bottom-6 -left-8 text-primary/40 text-sm font-mono floating opacity-0 group-hover/profile:opacity-100 transition-opacity delay-300">
                            ...
                            <div className="absolute -bottom-4 -right-6 text-primary/40 text-sm font-mono floating opacity-0 group-hover/profile:opacity-100 transition-opacity delay-400">
                            ...
                            <div className="absolute top-1/2 -left-12 w-8 h-0.5 bg-primary/30 opacity-0 group-hover/profile:opacity-100">
                                <div className="w-2 h-full bg-primary data-flow"></div>
                            </div>
                            <div className="absolute top-1/2 -right-12 w-8 h-0.5 bg-primary/30 opacity-0 group-hover/profile:opacity-100">
                    ...
                    <h2 className="text-xl font-bold mt-4 text-white space-y-1">
                        <div className="flex items-center justify-center space-x-2">
                            <span className="text-primary font-mono animate-pulse terminal-cursor">$</span>
                            <span className="text-white">Ahmed Alkhatim</span>
                    ...
                    <div className="space-y-2 mt-3">
                        ...
                        <div className="flex items-center justify-center space-x-4 text-xs font-mono">
                            <div className="text-green-400">
                                Last seen: <span className="text-primary">{currentTime.toLocaleString()}</span>
                            </div>
                ...
                <div className="relative z-10">
                    <div className="grid grid-cols-4 gap-3 mb-6">
                        {developerStats.map((stat, index) => (
                            <div 
                                key={index} 
                                className="text-center p-3 bg-gradient-to-br from-black/40 to-gray-900/40 rounded-lg border border-primary/20 hover:border-primary/60 transition-all duration-500 cursor-pointer group/stat hover:scale-105 backdrop-blur-sm"
                                style={{
                                    animationDelay: `${index * 0.1}s`
                                }}
                            >
                                <div className="text-3xl mb-2 group-hover/stat:animate-bounce transition-transform duration-300">
                                    {stat.icon}
                                </div>
                                <div className={`text-${stat.color} font-bold text-xl font-mono group-hover/stat:text-yellow-300 transition-colors duration-300`}>
                                    {stat.value}
                                </div>
                    ...
                    <div className="text-center text-xs text-primary/70 font-mono bg-black/20 rounded p-2 border border-primary/10">
                        <div className="flex justify-center items-center space-x-4">
                            ...
                            <span className="text-yellow-400">{activeConnections} active sessions</span>
                        </div>
                    </div>
                </div>

                {/* Ultra-enhanced contact information with interactive elements */}
                <div className="relative z-10 space-y-3">
                    <div className="flex items-center justify-between mb-4">
                        <div className="text-primary text-sm font-mono">// Contact endpoints</div>
                    ...
                    <div className="group/item">
                        <div className="flex items-center justify-between hover:bg-gradient-to-r hover:from-green-500/10 hover:to-transparent p-4 rounded-lg transition-all duration-300 border border-transparent hover:border-green-500/30 cursor-pointer">
                            <div className="flex items-center space-x-4">
                                <div className="w-10 h-10 bg-gradient-to-br from-green-500/30 to-green-500/10 rounded-lg flex items-center justify-center group-hover/item:scale-110 transition-transform duration-300">
                            ...
                            <div className="flex items-center space-x-2">
                                <div className="text-xs text-green-400/60 font-mono opacity-0 group-hover/item:opacity-100 transition-opacity duration-300">
                                    GSM
                                </div>
                                <div className="w-2 h-2 bg-green-400 rounded-full opacity-0 group-hover/item:opacity-100 animate-pulse"></div>
                            </div>
                ...
                {/* Advanced 3D hover effect overlay with particle system */}
                <div className="absolute inset-0 border-2 border-primary/0 group-hover:border-primary/60 rounded-tl-[160px] rounded-br-[160px] transition-all duration-500 pointer-events-none">
                    {/* Corner indicators */}
